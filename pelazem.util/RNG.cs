...
namespace pelazem.util
{
	...
	/// 
	/// Modified slightly by Patrick El-Azem to add a GetUniform() overload and a couple of other minor tweaks.
	/// </summary>
	public class RNG
	{
		...
		{
			return (Converter.GetInt32(GetUniform(1000000, 2000000)) % 2) == 0;
		}
	}
}
